...
import { useFc3d, type Fc3dSelectItem } from '~/composables/useFc3d'

/**
 * 當前注項
 *
 * fc3d 有 3 種看板型態（比照 useFc3d 的 board 狀態）：
...
const click = {
  coinInput: (item: Fc3dSelectItem, event: Event) => {
  ...
  coinBlur: (item: Fc3dSelectItem, event: Event) => {
    const target = event.target as HTMLInputElement
...
<template>
  <section class="block-main fc3d-curr">
    <div class="curr-head">
