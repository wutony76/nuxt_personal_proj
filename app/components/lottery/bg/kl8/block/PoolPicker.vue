 ...
 *   彩池玩法是「固定選 3 碼 → 一注 → 依命中顆數分層派彩」，兩者判定與送單邏輯完全獨立
 *   （見 shared/config/kl8-cd.ts 的 kl8PoolMatchCount／KL8_POOL_PRIZE_TIERS），
 *   互動模型雖然都是「號碼池」，但不共用同一份選號狀態（poolPlay vs renxuan）。
 * ⚠️ 這個玩法刻意不進 kl8cd/plays.js 看板網格（比照 k3-of 的 xuanhao），
...
<template>
  <div class="kl8-pool-picker">
    ...
    <div class="play-group">
      <div class="group-title">號碼 01 ~ 80</div>
