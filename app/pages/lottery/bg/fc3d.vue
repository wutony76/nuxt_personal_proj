...
import Fc3dHeader from '~/components/lottery/bg/fc3d/block/Header.vue'
import Fc3dBoard from '~/components/lottery/bg/fc3d/base/Board.vue'
import CurrItems from '~/components/lottery/bg/fc3d/block/CurrItems.vue'
import Controls from '~/components/lottery/bg/fc3d/block/Controls.vue'
import Report from '~/components/lottery/bg/fc3d/block/Report.vue'
import History from '~/components/lottery/bg/fc3d/block/History.vue'
import Road from '~/components/lottery/bg/fc3d/block/Road.vue'
import DialogUser from '~/components/lottery/bg/fc3d/block/DialogUser.vue'
import DialogOpenCode from '~/components/lottery/bg/fc3d/block/DialogOpenCode.vue'
import DialogRule from '~/components/lottery/bg/fc3d/block/DialogRule.vue'
 ...
 * 福彩3D官方玩法
 *
 * 注項一律讀 shared/config/fc3dof 的設定檔，賠率由 helpers 依該分頁 rtp 即時推算，
 * 畫面顯示與伺端鎖進注單的值一致。
 * ⚠️ 與 EGGS 同款單頁骨架（無盤口切換），但 fc3d 沒有彩池／爆池，也沒有選號彩池玩法，
...
<template>
  <div class="base lottery-fc3d">
    ...
    <main class="main">
      <Fc3dHeader @open-opencode-dialog="dialogClick.openOpenCode()" />
...
.lottery-fc3d {
  ...
  .bg-fx {
    ...
    .orb {
      ...
      animation: fc3d-orb-rise calc(7s + var(--i) * 0.6s) ease-in infinite;
  ...
  .info-warp {
    ...
    gap: 0.75rem;
    align-items: stretch;
    animation: fc3d-sec-in 0.55s ease both;
    ...
    .info-side {
      ...
      .user-warp {
        ...
        cursor: pointer;
        animation: fc3d-card-glow 3.5s ease-in-out infinite;
