...
import SscOfBoard from '~/components/lottery/bg/ssc/of/base/Board.vue'
...
/**
 * 未登入處理：與 ssc-cd 一致 —— 先 await useAuth().init() 確認登入狀態，
...
<template>
  <div class="base lottery-ssc is-of">
    <div class="bg-fx">
    ...
    <main class="main">
      ...
      <section class="play-warp">
        ...
        <div class="play-tabs">
          ...
          <NuxtLink to="/lottery/bg/ssc-cd" class="mode-link">切換信用玩法 →</NuxtLink>
        </div>
...
<style lang="scss">
/* ── 版面骨架：與 ssc-cd 同一套（容器寬度、卡片邊框陰影、進場動畫）───────── */
