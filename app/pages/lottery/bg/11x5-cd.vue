 ...
 * 階段 2 的官方盤會讀同一份。
 *
 * ⚠️ 階段 1 沒有官方盤頁面，所以玩法列右側**沒有**「切換官方玩法」連結
 *    （ssc-cd 那邊有）—— 指向不存在的路由只會 404。階段 2 補 11x5-of.vue 時一併加回。
 */
const {
  state: mxState,
  wallet: mxWallet,
    ...
    <main class="main">
      ...
      <section class="play-warp">
        ...
        <div class="play-tabs">
          ...
          <!-- ⚠️ 階段 2 補上官方盤頁面後，這裡加回 <NuxtLink to="/lottery/bg/11x5-of">切換官方玩法 →</NuxtLink> -->
        </div>
