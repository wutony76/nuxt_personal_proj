 ...
 * ⚠️ 範圍沿用 PK10_POOL_BASE_MIN/MAX（共用彩池的既有池底範圍），只是套用在爆池這個獨立的池上，
 *    兩個池底互不影響、各自隨機。
 */
export const PK10_JACKPOT_BASE_MIN = PK10_POOL_BASE_MIN
export const PK10_JACKPOT_BASE_MAX = PK10_POOL_BASE_MAX
...
export function pk10RegisterJackpotBoard(board: PK10JackpotBoard): void {
  ...
  _jackpotSeeded = true
  PK10_JACKPOT.carry = LOTTERY_BASE.jackpotBase(PK10_JACKPOT_BASE_MIN, PK10_JACKPOT_BASE_MAX)
}
