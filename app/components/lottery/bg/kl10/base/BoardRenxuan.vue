 ...
 *   表格看板（正和／龍虎鬥／兩面）是「一注項一金額」；任選是複式：
 *   先從 01~20 選 k 個號碼，再依 C(k, N) 展開成多注、共用同一個單注金額
 *   （與來源 `bglottery kl10/allTraditional/renxuan/play.vue` 同一套互動）。
